...
export default {
  en: {
    ...
    body: {
      ...
      web3: {
        ...
        contributeLabel: 'How much ETH do you want to contribute?',
        total: 'Total',
  ...
  pt: {
    header: {
      ...
      dates: ' Início: 11 de Janeiro de 2020 Final: 11 de Fevereiro de 2020'
    },
    body: {
      title: 'Venda de PNK Kleros',
  ...
  es: {
    ...
    body: {
      ...
      web3: {
        ...
        unlock: 'Desbloquear Metamask para contribuir'
      },
      totals: {
        title: 'Un total de 150 millones de Pinakion (PNK) serán vendidos.',
        amountForSale: 'Cantidad a Vender',
        totalSold: 'Cantidad Vendida',
        remaining: 'Cantidad Restante a Vender'
      }
    },
    orders: {
  ...
  ru: {
    ...
    body: {
      ...
      basic: {
        ...
        disclaimer: (
          <>
            <sup>*</sup>Заказы с наименьшей ценой будут выполнены первыми.
          </>
        )
      },
      web3Heading: 'Web3',
